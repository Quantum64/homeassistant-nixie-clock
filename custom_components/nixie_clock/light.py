...
class NixieDisplay(NixieEntity, LightEntity):
    ...
    async def async_turn_on(self, **kwargs: Any) -> None:
        await self.coordinator.config_entry.runtime_data.client.async_set_param(PARAM_BRIGHTNESS, math.ceil(percentage_to_ranged_value((1, 255), kwargs[ATTR_BRIGHTNESS])))
        await self.coordinator.async_request_refresh()
